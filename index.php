	...
	<script type="text/javascript">
		...
		function show_modal(id){
			...
			$('#exampleModalLabel').on('show.bs.modal', function (event) {
			  ...
			  var recipient = result[id].nome_item // Extract info from data-* attributes
			  ...
			  modal.find('.modal-body').append("<b>Descrição do item:</b><br>" + result[id].descricao)
